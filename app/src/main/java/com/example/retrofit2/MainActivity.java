...
import com.example.retrofit2.Retrofit.Interface.RecyclerInterface;
import com.example.retrofit2.Retrofit.ModelRecycler;
import com.example.retrofit2.Retrofit.RetrofitAdapter;
    ...
    private void writeRecycler(String response){
        ...
        try {
            ...
            for (int i = 0; i < dataArray.length(); i++) {
                ...
                modelRecycler.setCity(dataobj.getString("phone"));
